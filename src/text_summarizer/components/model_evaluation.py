...
class ModelEvaluation:
    ...
    def generate_batch_size_chunks(self, list_of_elements, batch_size):
        """Split dataset into smaller batches so we can process simultaneously
    ...
    def calculate_metric_on_train_ds(
        ...
        article_batches = list(
            self.generate_batch_size_chunks(dataset[column_text], batch_size)
        )
        target_batches = list(
            self.generate_batch_size_chunks(dataset[column_summary], batch_size)
        )
